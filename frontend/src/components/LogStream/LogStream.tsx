...
// LogStream renders a live tail of the active node's log file (flnd.log via
// /api/logs/stream). It owns its own SSE connection with a 3s reconnect loop.
// Used both by the Settings → Logs tab and the standalone LogOverlay.
